...
<template>
	<div class="relative h-screen flex justify-center items-center">
		<div class="bg-green-200 shadow-xl w-[20vw] absolute h-[40vh] rounded-2xl">
			<h2 class="flex justify-center text-[1.5vw] font-semibold mt-[3vh]">
				Login
			</h2>
			<Form
				@submit="onSubmit"
			...
			>
				...
				<div class="flex items-center justify-center mt-[4vh]">
					...
					>
						<div
							v-show="isSubmitting"
							class="absolute -translate-x-1/2 left-1/2 mt-8"
						>
							<div
				...
				<div
					...
					class="flex items-center justify-center mt-[1vh]"
				>
					{{ errors.apiError }}
				</div>
			</Form>
